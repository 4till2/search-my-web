...
ActiveRecord::Schema.define(version: 2022_02_09_195657) do
  ...
  create_table "hydrations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["page_id"], name: "index_hydrations_on_page_id"
  end
  ...
  create_table "locations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["page_id", "word_id"], name: "index_locations_on_page_id_and_word_id"
    t.index ["page_id"], name: "index_locations_on_page_id"
    t.index ["word_id"], name: "index_locations_on_word_id"
  end
  ...
  add_foreign_key "hydrations", "pages"
